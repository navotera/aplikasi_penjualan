...
<div class="panel panel-default">
    <div class="panel-heading">Form Transaksi <span class="pull-right" style="color: grey; font-size:14px"> Operator : <?= UserORM::getName($_SESSION['UserID']); ?></span></div>
        ...
        <form class="form-horizontal " id="form_transaksi" method="POST" action="<?= app_path(); ?>/transaksi/save.php">
            ...
            <div class="row">
                <div class="col-md-12 clearfix">
                    ...
                    <h3> Detail Barang
                        <a class="pull-right btn btn-xs btn-primary" href="#" role="button" data-toggle="modal" data-target="#formDetailTrx"><i class="fa fa-plus"></i> Tambah</a>
                    </h3>
...
<!-- Modal -->
<div class="modal fade" id="formDetailTrx" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="" name="harga" class="form-control money " placeholder="Harga / unit" readonly>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    function getHargaBarang(barangID) {
        ...
        var url = '<?= app_path(); ?>/transaksi/getHargaBarangAjax.php?barangId=' + barangID;
    ...
    $(document).on("input", "input[name=jumlah]", function(e) {
        harga = $('input[name=harga]').val().split('.').join("");
        jumlah = $(this).val();
        total = harga * jumlah;
